        ...
        ctaActions={[
          {
            ...
            title: "Our Mission",
            description:
              "To offer businesses of all sizes innovative and customizable ecommerce solutions that follow future trends.",
          },

          {
            icon: TbEye,
            title: "Our Vision",
            description: "To be the leading provider of cutting-edge ecommerce solutions globally.",
          },
        ]}
        ctaHeroProps={{
          type: "video",
          videoProps: {
            autoPlay: true,
            controls: true,
            poster: "/images/pie.svg",
            src: "https://youtu.be/wUNHpMc2bQQ",
          },
        }}
        ctaStats={[
          { title: "Projects", counter: { suffix: "+", number: 35 } },
          { title: "Clients", counter: { suffix: "+", number: 30 } },
          { title: "Regions", counter: { suffix: "+", number: 10 } },
          { title: "Developers", counter: { suffix: "+", number: 40 } },
        ]}
        ...
        faqs={[
          {
            ...
            answer: `The timeline for launching a product depends on various factors such as the complexity of the project and client requirements.`,
            icon: () => (
              <svg
                width="30"
                height="25"
          ...
          },
          {
            ...
            answer: `Yes, our solutions are highly customizable to meet the unique needs and requirements of your business.`,
            icon: () => (
              <svg
                width="30"
                height="25"
          ...
          },
          {
            ...
            answer: `Yes, we provide ongoing support and maintenance to ensure the smooth functioning of your ecommerce platform. The service can be paid or even free based on the agreement.`,
            icon: () => (
              <svg
                width="30"
                height="25"
          ...
          },
          {
            ...
            answer: `Yes, we offer free consultations to understand your business requirements and provide you with the best possible ecommerce solutions.`,
            icon: () => (
              <svg
                width="30"
                height="25"
                ...
                xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M30.3309 16.405L17.5809 3.65504C17.0709 3.14504 16.3625 2.83337 15.5834 2.83337H5.66671C4.10837 2.83337 2.83337 4.10837 2.83337 5.66671V15.5834C2.83337 16.3625 3.14504 17.0709 3.66921 17.595L16.4192 30.345C16.9292 30.855 17.6375 31.1667 18.4167 31.1667C19.1959 31.1667 19.9042 30.855 20.4142 30.3309L30.3309 20.4142C30.855 19.9042 31.1667 19.1959 31.1667 18.4167C31.1667 17.6375 30.8409 16.915 30.3309 16.405ZM18.4167 28.3475L5.66671 15.5834V5.66671H15.5834V5.65254L28.3334 18.4025L18.4167 28.3475Z"
                  fill="currentColor"
                />
                <path
                  d="M9.20837 11.3334C10.382 11.3334 11.3334 10.382 11.3334 9.20837C11.3334 8.03477 10.382 7.08337 9.20837 7.08337C8.03477 7.08337 7.08337 8.03477 7.08337 9.20837C7.08337 10.382 8.03477 11.3334 9.20837 11.3334Z"
                  fill="currentColor"
                />
              </svg>
            ),
          ...
          {
            id: "item-5",
            question: "Can you migrate my existing ecommerce platform?",
            answer: `Yes, we provide migration services to help you seamlessly transition from your existing ecommerce platform to our solutions.`,
            icon: () => (
              <svg
                width="30"
                height="25"
                ...
                xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M20.1875 29.75C20.7743 29.75 21.25 29.2743 21.25 28.6875C21.25 28.1007 20.7743 27.625 20.1875 27.625C19.6007 27.625 19.125 28.1007 19.125 28.6875C19.125 29.2743 19.6007 29.75 20.1875 29.75Z"
                  fill="currentColor"
                />
                <path
                  d="M30.8125 32.9375H17C15.8281 32.9375 14.875 31.9844 14.875 30.8125V26.5625C14.875 25.3906 15.8281 24.4375 17 24.4375H30.8125C31.9844 24.4375 32.9375 25.3906 32.9375 26.5625V30.8125C32.9375 31.9844 31.9844 32.9375 30.8125 32.9375ZM17 26.5625V30.8125H30.8125V26.5625H17ZM30.8125 22.3125H17C15.8281 22.3125 14.875 21.3594 14.875 20.1875V15.9375C14.875 14.7656 15.8281 13.8125 17 13.8125H30.8125C31.9844 13.8125 32.9375 14.7656 32.9375 15.9375V20.1875C32.9375 21.3594 31.9844 22.3125 30.8125 22.3125ZM17 15.9375V20.1875H30.8125V15.9375H17Z"
                  fill="currentColor"
                />
                <path
                  d="M12.75 29.0062C7.80619 27.251 4.25 22.5388 4.25 17C4.25 9.96944 9.96944 4.25 17 4.25C22.1329 4.25 26.5561 7.30575 28.5759 11.6875H30.8773C28.7321 6.10512 23.3293 2.125 17 2.125C8.7975 2.125 2.125 8.7975 2.125 17C2.125 23.7256 6.61406 29.4153 12.75 31.2481V29.0062Z"
                  fill="currentColor"
                />
              </svg>
            ),
          },
          {
            ...
            answer: `Yes, we provide post-launch support to address any issues or concerns and ensure the smooth operation of your ecommerce platform.`,
            icon: () => (
              <svg
                width="30"
                height="25"
          ...
          {
            id: "item-7",
            question: "Do you offer training for using the ecommerce platform?",
            answer: `Yes, we provide comprehensive training to help you effectively use and manage your ecommerce platform. We even provide various live events and videos related to our services.`,
            icon: () => (
              <svg
                width="30"
                height="25"
          ...
          },
          {
            ...
            answer:
              "We support a wide range of payment methods to ensure that your customers can make purchases conveniently. Some of the popular payment methods we support include credit/debit cards, digital wallets like PayPal and Apple Pay, bank transfers, and more. We can also integrate with specific payment gateways based on your business needs.",
            icon: () => (
              <svg
                width="30"
                height="25"

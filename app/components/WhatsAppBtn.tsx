export function WhatsAppBtn({ whatsAppNumber }: { whatsAppNumber: string }) {
  return (
    <a
      target="_blank"
      rel="noreferrer"
      ...
      className="overflow-hidden group fixed bottom-4 right-4 rounded-xl h-12 p-3 flex justify-center items-center shadow-lg text-white z-50 bg-[#2ace67]">
      <svg viewBox="64 64 896 896" className="w-full h-full" fill="currentColor">
